...
export const campaigns = sqliteTable('campaigns', {
  ...
  // Highest live session.number for campaign position UI (issue #841). Denormalized
  // alongside sessionCount; backfilled via migrateCampaignsTableForLatestSessionNumber.
