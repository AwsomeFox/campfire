...
-- Issue #729: durable, metadata-only data repair diagnostics.  These tables
-- intentionally carry no entity bodies except the narrowly scoped quarantine
-- payload needed for one-row undo.
