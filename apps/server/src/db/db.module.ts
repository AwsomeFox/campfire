...
const MIGRATIONS: ReadonlyArray<{ name: string; run: (sqlite: Database.Database) => void }> = [
  ...
  // (#547) migrations; this branch merges after them, so the scheduling lifecycle
  // migration takes the next free ordinal rather than collide.
  { name: '0110_scheduling_lifecycle_504', run: migrateSchedulingLifecycle504 },
];
