...
const MIGRATIONS: ReadonlyArray<{ name: string; run: (sqlite: Database.Database) => void }> = [
  ...
  { name: '0098_factions_portrait_url', run: migrateFactionsTableForPortraitUrl },
  { name: '0099_locations_portrait_url', run: migrateLocationsTableForPortraitUrl },
  { name: '0100_ai_scribe_session_scope_499', run: migrateAiScribeSessionScope499 },
];
