...
const MIGRATIONS: ReadonlyArray<{ name: string; run: (sqlite: Database.Database) => void }> = [
  ...
  // 0107-0109 were claimed on main by #542/#563/#547 and 0110 by the scheduling
  // lifecycle branch (#504); this branch merges after them, so the AI consent
  // provenance migration takes the next free ordinal rather than collide.
  { name: '0111_ai_consent_provenance_501', run: migrateAiConsentAndProvenance501 },
];
