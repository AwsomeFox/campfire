...
> = {
  prep: {
    ...
    award_xp: 'confirm',
    apply_encounter_aftermath_xp: 'confirm',
    transfer_encounter_aftermath_loot: 'confirm',
    update_encounter_aftermath_quest: 'confirm',
    update_encounter_aftermath_beat: 'confirm',
    add_encounter_aftermath_timeline_event: 'confirm',
  ...
  aftermath: {
    ...
    begin_encounter: 'confirm',
    award_xp: 'auto',
    apply_encounter_aftermath_xp: 'auto',
    transfer_encounter_aftermath_loot: 'auto',
    update_encounter_aftermath_quest: 'auto',
    update_encounter_aftermath_beat: 'auto',
    add_encounter_aftermath_timeline_event: 'auto',
    level_up_character: 'confirm',
    add_note: 'auto',
