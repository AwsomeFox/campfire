...
export const CAMPAIGN_BROADCAST_SAFE_FRAMES: Record<BroadcastSafeFrameType, string> = {
  ...
  'encounter.turn_changed': 'Public turn state.',
  'encounter.deleted': 'Id-only signal.',
  'encounter.ping': 'Public map click.',
  ...
  'membership.updated': 'Public role change.',
  'treasury.updated': 'Thin invalidation signal.',
  'character.updated': 'Thin invalidation signal.',
  'check.requested': 'Thin invalidation signal.',
  'check.resolved': 'Thin signal.',
  'campaign.trashed': 'Filtered server-side, never sent as data.',
  'safety.hold': 'Active state only, no actor identity.',
