...
import { AiDmReadiness, AiDmSeatUpdate, AiDmTurnRequest, CoDmDraftRequest } from '@campfire/schema';
...
export class AiDmReadinessDto extends createZodDto(AiDmReadiness) {}
