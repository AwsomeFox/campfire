...
import { AiCapsUpdate, AiKillSwitchUpdate, AiAllowlistUpdate, AiPricingUpdate } from '@campfire/schema';
...
export class AiPricingUpdateDto extends createZodDto(AiPricingUpdate) {}
