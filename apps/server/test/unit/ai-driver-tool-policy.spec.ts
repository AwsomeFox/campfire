  ...
  describe('#1500 tool-policy unit coverage gaps: default-deny, delete_ branch, prep overrides, undoable, and precedence', () => {
    ...
    it('asserts the prep profile overrides table', () => {
      const prepCases: Array<{ tool: string; expectedPolicy: string }> = [
        ...
        { tool: 'apply_encounter_aftermath_xp', expectedPolicy: 'confirm' },
        { tool: 'transfer_encounter_aftermath_loot', expectedPolicy: 'confirm' },
        { tool: 'update_encounter_aftermath_quest', expectedPolicy: 'confirm' },
        { tool: 'update_encounter_aftermath_beat', expectedPolicy: 'confirm' },
        { tool: 'add_encounter_aftermath_timeline_event', expectedPolicy: 'confirm' },
