...
type AiDriverCtor = ConstructorParameters<typeof AiDriverService>;
/**
...
describe('AiDriverService — secret-read approvals are bounded (#1059)', () => {
  const CAMPAIGN = 1;
  const dmUser = { id: 'dm-1' } as unknown as RequestUser;
  ...
  function makeService() {
    ...
    const svc = new AiDriverService(
      aiDm as unknown as AiDriverCtor[0],
      undefined as unknown as AiDriverCtor[1],
      audit as unknown as AiDriverCtor[2],
      stream as unknown as AiDriverCtor[3],
      undefined as unknown as AiDriverCtor[4],
      undefined as unknown as AiDriverCtor[5],
      undefined as unknown as AiDriverCtor[6],
      undefined as unknown as AiDriverCtor[7],
      undefined as unknown as AiDriverCtor[8],
    );
