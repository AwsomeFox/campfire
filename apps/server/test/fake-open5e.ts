...
const CREATURES = [
  ...
  {
    // Synthetic open fixture, expressed in the exact live Open5e v2 creature shape:
    // traits[] plus one actions[] list partitioned by action_type.
    key: 'srd_fixture-sentinel',
    name: 'Fixture Sentinel',
    type: { name: 'Construct', key: 'construct' },
    ...
    actions: [
      {
        name: 'Multiattack',
        desc: 'The sentinel makes two arc blade attacks.',
        attacks: [],
        action_type: 'ACTION',
        order_in_statblock: 0,
        legendary_action_cost: null,
      ...
      {
        name: 'Arc Blade',
        desc: 'Melee Weapon Attack: +6 to hit. Hit: 11 (2d6 + 4) lightning damage.',
        attacks: [
          {
            name: 'Arc Blade attack',
            attack_type: 'WEAPON',
            to_hit_mod: 6,
            damage_die_count: 2,
            damage_die_type: 'D6',
            damage_bonus: 4,
            damage_type: { name: 'Lightning', key: 'lightning' },
            extra_damage_die_count: null,
            extra_damage_die_type: null,
            extra_damage_bonus: null,
            extra_damage_type: null,
      ...
      {
        name: 'Static Burst',
        desc: 'Each nearby creature must make a DC 15 Dexterity saving throw or take 14 (4d6) lightning damage.',
        attacks: [],
        action_type: 'ACTION',
      ...
      {
        name: 'Deflect',
        desc: 'The sentinel adds 2 to its armor class against one attack that would hit it.',
        attacks: [],
      ...
      {
        name: 'Sweep',
        desc: 'The sentinel makes one arc blade attack.',
        attacks: [],
    ...
    traits: [{ name: 'Immutable Form', desc: 'The sentinel is immune to effects that would alter its form.' }],
    document: DOCUMENT,
  },
];
