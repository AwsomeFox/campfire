...
export function QuickCaptureDialog({
  ...
  return (
    <Dialog
      ...
      titleId={titleId}
      titleAs="h2"
      className="w-full max-w-lg [&_.dialog-title]:[font-family:inherit] [&_.dialog-title]:text-lg [&_.dialog-title]:font-semibold [&_.dialog-title]:text-white [&_.dialog-title]:mb-4"
