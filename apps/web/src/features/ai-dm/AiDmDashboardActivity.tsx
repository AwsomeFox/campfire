  ...
  return (
    <Card density="compact" elev="sm" style={{ padding: 12, gap: 8 }}>
      ...
      {showProposalNudge && (
        ...
        >
          <span className="flex-1 min-w-0"><GameIcon slug="quill-ink" size={UI_ICON_SIZE.xs} className="inline align-text-bottom mr-1" />The AI drafted something for review.</span>
