...
export function PartyRestPanel({ campaignId, characters, onClose, onApplied }: { campaignId: number; characters: Character[]; onClose: () => void; onApplied: () => void }) {
  ...
  async function makePreview() {
    ...
    try { setPreview(await api.post<Preview>(`${API}/campaigns/${campaignId}/characters/rest/preview`, kind === 'short' ? { kind, characterIds: ids, perCharacter: {} } : kind === 'custom' ? { kind, characterIds: ids, customResourceKeys: customKeys } : { kind, characterIds: ids })); }
