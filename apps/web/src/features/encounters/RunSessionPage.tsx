...
import type { ActionSpec, ActionUndoToken, AoeTemplate, CampaignLibraryMonster, CastSessionCreated, Character, Combatant, CombatantRemoveResult, CombatantKind, CombatantStatblock as CombatantStatblockData, DiceRoll, DifficultyBand, EncounterDifficulty, EncounterEvent, EncounterWithCombatants, TurnWorkspace as TurnWorkspaceData, FogState, GenerateMapParams, GeneratedMapResult, HpResyncDirection, HpSyncConflict, MapPing, Npc, RuleEntry, RulePack, TokenSize } from '@campfire/schema';
import { ARCHMAGE_ADAPTER_ID, COMBATANT_STATBLOCK_HELP, STARFINDER_ADAPTER_ID, buildDifficultyExplanation, defaultCombatantStatblock, fogStatesEqual, LAIR_INITIATIVE_COUNT, LEGENDARY_ACTION_SLOT, ruleSystemAdapter } from '@campfire/schema';
