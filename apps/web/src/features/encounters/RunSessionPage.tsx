  ...
  return (
    ...
    >
      ...
      */}
      ...
      <ResourceTrackerPanel campaignId={cid} encounterId={eid} characters={characters} combatants={orderedCombatants} canDmWrite={canDmWrite} ownedCharacterIds={ownedCharacterIds} />
