 ...
 *
 * Inactive invites (expired, exhausted, revoked, or campaign-suspended) show a
 * non-scannable overlay so a displayed QR is never misleadingly available.
 */
...
export interface InviteQrCardProps {
  ...
  /** When false (e.g. campaign public invites suspended), QR is not scannable. */
  scannable?: boolean;
}
