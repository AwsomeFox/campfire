...
export default function CampaignLibraryPage() {
  ...
  return <div className="space-y-4" data-testid="campaign-library-page"><PageHeader title="Campaign library" subtitle="Search, organize, and reuse campaign material." />{error ? <ErrorNote message={error} /> : null}{notice ? <p className="text-sm text-muted">{notice}</p> : null}
