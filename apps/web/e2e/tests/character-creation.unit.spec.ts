...
describe('character creation UI helpers (issue #719)', () => {
  it('offers starter templates for 5e, PF2e, and Open Legend', () => {
  ...
  it('blank sheet payload is an intentional draft without placeholder stats', () => {
