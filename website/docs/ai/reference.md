...
- **Tools:** 259 covering campaigns, quests, objectives, story arcs/beats/branches,
...
- **Resources:** 6 read surfaces (campaign index, campaign summary, party,
...
- **Prompts:** 2 authoring prompts (recap-writer, session-prep) — call
