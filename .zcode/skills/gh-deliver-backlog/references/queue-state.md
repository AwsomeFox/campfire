...
exactly. The main Goal ledger is authoritative for the run and the single
GitHub `## Agent Workpad` is the durable cross-tool record.
...
Use `Tool: zcode`, a unique run ID, the claim comment ID, UTC claim and lease
